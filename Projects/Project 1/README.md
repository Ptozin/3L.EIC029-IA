...
To run the application, you need to have [Make](https://www.gnu.org/software/make/) and [Python](https://www.python.org/) installed on your machine. Then, you can run the following command:
